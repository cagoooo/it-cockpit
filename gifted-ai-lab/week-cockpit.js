(function(){
  ...
  <main class="shell">
    ...
    <section class="visual-learning-wall" aria-label="本週圖像學習牆"><a class="visual-learning-card" href="week-illustration.webp" target="_blank"><img src="week-illustration.webp" width="1152" height="768" alt="${esc(data.title)}的 Q 版繪本圖"><span><b>故事情境</b>先看圖猜猜今天要做什麼</span></a><a class="visual-learning-card" href="student-infographic.webp" target="_blank"><img src="student-infographic-sm.webp" onerror="this.onerror=null;this.src='student-infographic.webp'" loading="lazy" alt="第 ${week} 週好懂版資訊圖"><span><b>好懂圖解</b>用一張圖整理重要想法</span></a><a class="visual-learning-card" href="depth-infographic.webp" target="_blank"><img src="depth-infographic-sm.webp" onerror="this.onerror=null;this.src='depth-infographic.webp'" loading="lazy" alt="第 ${week} 週研究挑戰圖"><span><b>再想一步</b>看看還能研究什麼問題</span></a></section>
    ...
    <section id="assessment" class="view">
      ...
      <section class="media-grid"><video class="week-video" controls preload="metadata" data-poster="../assets/gifted-lab-cover-v2.webp"><source src="video.mp4" type="video/mp4"></video><div><div class="status-box"><b>本週 NotebookLM 短影片</b><span class="video-status">正在確認影片狀態…</span></div><div class="resources media-links"><a class="resource picture-book-link" href="week-illustration.webp" target="_blank"><b>本週 Q 版繪本圖 →</b><span>看圖找出課程的三個重要線索</span></a><a class="resource" href="slides.pdf"><b>NotebookLM 本週簡報 →</b><span>本週專屬概念與任務教材</span></a><a class="resource" href="notebooklm-kai-slides-v2.html#slide-1"><b>黃凱揚老師帶課 Q 版新版投影片 →</b><span>可左右播放、全螢幕與觸控翻頁，老師和學生一起探索</span></a><a class="resource" href="notebooklm-kai-slides.html#slide-1"><b>原版 NotebookLM 投影片 →</b><span>保留原本版本，方便比較課程內容與人物風格</span></a><a class="resource" href="lecture-slides.html"><b>12 張互動投影簡報 →</b><span>全螢幕、總覽、鍵盤與觸控操作</span></a><a class="resource" href="notebook-faq.md"><b>NotebookLM FAQ 紀錄 →</b><span>由本週全部來源交叉整理的三個追問</span></a><a class="resource" href="video-captions.srt"><b>短影片字幕檔 →</b><span>動態字幕同步文字，可供播放器與剪輯使用</span></a><a class="resource" href="${esc(data.notebookUrl)}" target="_blank" rel="noopener noreferrer"><b>進入本週 NotebookLM →</b><span>繼續研究、查詢與產出教材</span></a></div></div></section>
  ...
  // 影片封面放在 data-poster，等所在分頁顯示、影片進入畫面附近才載入，隱藏分頁不白白下載封面圖
  addEventListener('load',()=>{
    const videos=document.querySelectorAll('video[data-poster]');
    const setPoster=video=>{video.poster=video.dataset.poster;video.removeAttribute('data-poster');};
    if(!('IntersectionObserver' in window)){videos.forEach(setPoster);return;}
    const observer=new IntersectionObserver(entries=>entries.forEach(entry=>{if(entry.isIntersecting){setPoster(entry.target);observer.unobserve(entry.target);}}),{rootMargin:'300px'});
