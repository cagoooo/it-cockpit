...
const core=['index.html','week-data.js','week-student-language.js','week-cockpit.js','week-learning-depth.js','week-phase-six.js','reports.html','reports.js','sync-status.html','sync-status.js','materials/teacher-guide.pdf','materials/student-workbook.pdf'];
const records=[];
...
const weeks=sandbox.window.GIFTED_WEEKS.map(item=>{
  ...
  const files=['index.html','lecture-slides.html','classroom-pack.html','student-task.html','student-guide.md','student-warmup.md','student-review.md','teacher-pack.pdf','slides.pdf','video.mp4','video-captions.srt','depth-video.mp4','depth-video-captions.srt','student-video-card.png'];
...
const manifest={schema_version:1,release:'2026.07.29-phase6.1',generated_at:new Date().toISOString(),formal_plan:{teacher:'黃凱揚老師',school:'桃園市龍潭區石門國民小學',school_year:'115',weeks:10,sessions:20,minutes_per_session:45,source:'materials/teacher-guide.pdf'},weeks,files:records};
