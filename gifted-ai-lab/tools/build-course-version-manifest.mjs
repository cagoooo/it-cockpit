...
const weeks=sandbox.window.GIFTED_WEEKS.map(item=>{
  ...
  const files=['index.html','lecture-slides.html','notebooklm-kai-slides.html','classroom-pack.html','student-task.html','student-guide.md','student-warmup.md','student-review.md','teacher-pack.pdf','slides.pdf','notebooklm-kai-slides.pdf','video.mp4','video-captions.srt','depth-video.mp4','depth-video-captions.srt','student-video-card.png','week-illustration.webp'];
...
const manifest={schema_version:1,release:'2026.08.28-kai-notebooklm-slide-player.2',generated_at:new Date().toISOString(),formal_plan:{teacher:'黃凱揚老師',school:'桃園市龍潭區石門國民小學',school_year:'115',weeks:10,sessions:20,minutes_per_session:45,source:'materials/teacher-guide.pdf'},weeks,files:records};
