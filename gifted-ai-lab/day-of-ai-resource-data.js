...
window.DAY_OF_AI_RESOURCES = [
  ...
  { id: 'lesson-1-practice', title: '第 1 課課後練習', url: 'https://docs.google.com/document/d/1Nt_YPXvkjvAU8iBoIXDpvvytV1PgId6G/edit', type: '課後練習', weeks: [3], audience: 'both', note: '完成 AI／不是 AI 探究後再使用。' },
  { id: 'lesson-1-question-card', title: '第 1 課命題卡與答案', url: 'https://docs.google.com/document/d/1TKvWR8eQLLa-RWryRgkV155RmIgmBJMF/edit', type: '教師評量', weeks: [3], audience: 'teacher', note: '含題目與答案，請由教師挑選後再提供給學生。' },
  ...
  { id: 'google-maps', title: 'Google 地圖：AI 線索觀察', url: 'https://www.google.com/maps', type: '生活網站', weeks: [3], audience: 'both', note: '觀察定位、路線規劃與交通資料，再說出判斷 AI 的證據。' },
  { id: 'cwa-weather-app', title: '中央氣象署生活氣象 App', url: 'https://www.cwa.gov.tw/V8/C/S/eservice/app/app_w.html', type: '生活網站', weeks: [3], audience: 'both', note: '比較天氣資料顯示與 AI 功能，不把所有數位工具都當成 AI。' },
  { id: 'chatgpt-observation', title: 'ChatGPT 圖文生成觀察', url: 'https://chatgpt.com/', type: '教師示範', weeks: [3], audience: 'teacher', note: '由教師示範輸入改變時輸出如何改變，不要求學生登入。', allowedStatuses: [403] },
  { id: 'ai-five-big-ideas', title: 'AI 五大概念海報', url: 'https://ai4k12.org/resources/big-ideas-poster/', type: '教師延伸', weeks: [3], audience: 'teacher', note: '感知、表示與推理、學習、自然互動、社會影響的原始參考。', language: '英文' },
  ...
  { id: 'quickdraw-bread-data', title: 'Quick, Draw! 麵包資料', url: 'https://quickdraw.withgoogle.com/data/bread', type: '資料觀察', weeks: [6, 9], audience: 'both', note: '直接比較一片吐司與整條麵包等不同畫法。' },
  { id: 'quickdraw-house-data', title: 'Quick, Draw! 房子資料', url: 'https://quickdraw.withgoogle.com/data/house', type: '資料觀察', weeks: [6, 9], audience: 'both', note: '找出房子畫法中常見的樣子，以及可能沒被看見的生活經驗。' },
  ...
  { id: 'lesson-2-practice', title: '第 2 課課後練習', url: 'https://docs.google.com/document/d/12n3Uh2AQfTTnPd_GkE4ZnB_oSaPXQ3U5/edit', type: '課後練習', weeks: [6], audience: 'both', note: '完成 Quick, Draw! 實驗後再使用。' },
  { id: 'lesson-2-question-card', title: '第 2 課命題卡與答案', url: 'https://docs.google.com/document/d/1wwxE-OWAOAcZu4brNf90vFQreRmoAQ7v/edit', type: '教師評量', weeks: [6], audience: 'teacher', note: '含題目與答案，請由教師挑選並改成中年級短句。' },
  ...
  { id: 'lesson-3-practice', title: '第 3 課課後練習', url: 'https://docs.google.com/document/d/1SvkdqD-GHNUrHWW4U7T_aKTKrj5Axxtn/edit', type: '課後練習', weeks: [9], audience: 'both', note: '用獅子被猜成狗的生活題，思考資料太少時如何改進。' },
  { id: 'lesson-3-question-card', title: '第 3 課命題卡與答案', url: 'https://docs.google.com/document/d/1KyzNrZZRUE4J783g2fERSAqNdQRbPPdT/edit', type: '教師評量', weeks: [9], audience: 'teacher', note: '含題目與答案，教師應先檢查顯示與難度再使用。' },
  ...
  { id: 'lesson-4-practice', title: '第 4 課課後練習', url: 'https://docs.google.com/document/d/13yBPzg8Hs86pt2YUby7CtBu4xZ52Nvap/edit', type: '課後練習', weeks: [12], audience: 'both', note: '練習把生活任務拆成放進什麼、怎麼做、得到什麼。' },
  { id: 'lesson-4-question-card', title: '第 4 課命題卡與答案', url: 'https://docs.google.com/document/d/191T244Evv4ij_PsOgIM0lax3-eyOlmCe/edit', type: '教師評量', weeks: [12], audience: 'teacher', note: '含題目與答案，適合作為教師備課與形成評量參考。' },
  ...
  { id: 'lesson-5-practice', title: '第 5 課課後練習', url: 'https://docs.google.com/document/d/1O1kPEIGUWaIdR7O8D6bObOo7UNJqjxUk/edit', type: '課後練習', weeks: [15], audience: 'both', note: '在老師機器人活動後，練習找出不清楚的指令。' },
  { id: 'lesson-5-question-card', title: '第 5 課命題卡與答案', url: 'https://docs.google.com/document/d/1PBhkdFMoOz0jwkc_ttZWfaJ0kHOMriq0/edit', type: '教師評量', weeks: [15], audience: 'teacher', note: '含逐項答案說明，僅放在教師備課篩選中。' },
